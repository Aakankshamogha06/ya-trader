...
<div id="full-container">
          ...
          <div class="row">
            <div class="col-md-7">
              <div class="banner-center-box text-white md-text-center">
                <h2>Looking to earn additional income in the finance industry?</h2>
                <div class="description">Our IB program offers competitive commission rates, flexible payout options, and a range of marketing materials to help you grow your business. We provide you with access to our advanced trading platform, reliable customer support, and a suite of analytical tools to help you optimize your performance.</div>
                ...
                <div class="col-md-12">
                  <a class="btn-video mt-40" target="_blank" href="https://www.youtube.com/@OfficialYaMarkets"> <i class="fa fa-play"></i> <span class="title"> Watch Our Education Videos </span> </a> 
                </div>
              </div>
            </div>
            <div class="col-md-5">
                  ...
                  <div class="box-title text-white">
                    ...
                    <div class="box-content">
                      <form action="mail.php" method="post">
                        ...
                        <div class="form-group">
                          <input type="phone" name="phone" id="phone" placeholder="Phone Number with country code*" class="form-control" required />
                        </div>
                        <div class="form-group">
                          <label for="location">Select your Location:</label>
                          <select name="location" id="state" class="form-control" required>
      ...
      <div class="company-items">
        <div class="row">
          <div class="col-md-6 info">
            <h3> Fill in your valuable details <span> </span> </h3>
  ...
  <div class="companies-area shape-theme text-light default-padding">
    <div class="container">
      <div class="row">
        <div class="col-md-6 info">
          <h3>After filling in your details, we will get in touch with you </h3>
  ...
  <div class="companies-area default-padding">
    <div class="container">
      <div class="company-items">
        <div class="row">
          <div class="col-md-6 info">
            <h3>Deposit Now and start Trading</h3>
      ...
      <div id="cta-title-1" class="flat-section">
        <div class="section-content">
          <div class="container">
            <div class="row">
              <div class="col-md-12 text-center">
                <h1>Join Now! A Revolutionary <span class="colored">Trading Platform</span></h1>
                <!-- <p>Trade or Follow Traders and Earn additional stable as a Copy Trading</p> -->
                <p><a class="btn scroll-to x-large colorful hover-colorful-darken mt-40" href="#banner">Register Now</a></p>
                 </div>
            </div>
          </div>
        </div>
      ...
      <div class="footer-bar-wrap">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <div class="fb-row">
                <div class="copyrights-message"> 2016 - 2023 © <a href="https://www.yamarkets.com" target="_blank"><span class="colored">YaMarkets Limited</span></a>. All Rights Reserved. </div>
